 ...
 *         &lt;element name="Keywords" type="{http://manuscript/module/manuscript/management/bean}keyword" maxOccurs="unbounded"/&gt;
...
public class Submission implements HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            XMLGregorianCalendar theLastModifyDate;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            List<Keyword> theKeywords;
            theKeywords = (((this.keywords!= null)&&(!this.keywords.isEmpty()))?this.getKeywords():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "keywords", theKeywords), currentHashCode, theKeywords, ((this.keywords!= null)&&(!this.keywords.isEmpty())));
        }
        {
            List<AcademicDisciplines> theAcademicDisciplines;
            theAcademicDisciplines = (((this.academicDisciplines!= null)&&(!this.academicDisciplines.isEmpty()))?this.getAcademicDisciplines():null);
